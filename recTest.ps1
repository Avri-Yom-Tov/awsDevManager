...
$target_profile_name = 'test-dev' # This is the local profile name you use to when accessing these credentials (e.g., dev, test-nvir, etc.)
$target_account_num = '211125581625' # This is the account number of the account alias you want to access (e.g., 934137132601 is for dev. See table below for more)
...
if ($lastexitcode -eq 0) {
	...
	$env:AWS_SESSION_TOKEN = $token_creds.Credentials.SessionToken
